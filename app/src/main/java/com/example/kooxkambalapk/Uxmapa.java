...
public class Uxmapa extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.uxubi);
        ...
        webView.loadUrl("https://www.google.com/maps/search/ruinas+de+uxmal/@20.3587888,-89.7881702,14z/data=!3m1!4b1");
