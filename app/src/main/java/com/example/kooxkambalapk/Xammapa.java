...
public class Xammapa extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.xamubi);
        ...
        webView.loadUrl("https://www.google.com/maps/search/ruinas+xaman+ha+/@20.6178239,-87.0867147,16z/data=!3m1!4b1");
